...
public class OwnerController extends BaseController<OwnerEntity, OwnerDto, OwnerFilter> {
    ...
    public ResponseEntity<FullOwnerDto> findOwnerWithPets(@RequestParam UUID ownerId){
        return ResponseEntity.ok().body(ownerService.findOwnersWithPets(ownerId));
    }
}
